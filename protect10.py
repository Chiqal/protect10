...
admin=["u22ed21bd97a4291726fa53b756ce2f01","uab9e9a4220733668859368b2a68285fb","u2c723b29dd222fe3f6bf70304c476230","ufd446574ba860923aeb438c933c836ce","ufafdbacbff38226d151940789db301d7","u1419826892f933d1280d8f59a485a929","u98a5ab007afdcc8ba74a33b778bc65f4"]
            ...
            if op.param3 in mid7:
              if op.param2 not in Bots or admin:
                try:
                  ...
                  kr4.updateGroup(G)
                  Ticket = kr4.reissueGroupTicket(op.param1)
                  kr7.acceptGroupInvitationByTicket(op.param1,Ticket)
                  time.sleep(0.01)
                  G.preventJoinByTicket = True
                  kr5.updateGroup(G)
                  wait["blacklist"][op.param2] = True
            ...
            if op.param3 in mid8:
              if op.param2 not in Bots or admin:
                try:
                  ...
                  kr4.updateGroup(G)
                  Ticket = kr1.reissueGroupTicket(op.param1)
                  kr8.acceptGroupInvitationByTicket(op.param1,Ticket)
                  time.sleep(0.01)
                  G.preventJoinByTicket = True
                  kr6.updateGroup(G)
                  wait["blacklist"][op.param2] = True
            ...
            if op.param3 in mid10:
              if op.param2 not in Bots or admin:
                try:
                  ...
                  kr8.updateGroup(G)
                  Ticket = kr5.reissueGroupTicket(op.param1)
                  kr10.acceptGroupInvitationByTicket(op.param1,Ticket)
                  time.sleep(0.01)
                  G.preventJoinByTicket = True
                  kr2.updateGroup(G)
                  wait["blacklist"][op.param2] = True
                    ...
                    if msg.toType == 2:
                        if msg.toType == 2:
                            ...
                            if targets == []:
                                ...
                                for target in targets:
                                    try:
                                        klist=[kr1,kr2,kr3,kr4,kr5,kr6,kr7,kr8,kr9,kr10]
...
#==============================================================================#
                ...
                if msg.from_ in owner:
                    ...
                    h = kr6.getContact(mid)
                    h = kr7.getContact(mid2)
                    h = kr8.getContact(mid3)
                    h = kr9.getContact(mid4)
                    h = kr10.getContact(mid5)
                    kr1.sendText(msg.to,"═══[DisplayName]═══\n" + h.displayName)
...
#=================================KRIS SCRIPT FINISHED =============================================#
              ...
              if msg.from_ in admin:
                  if msg.toType == 2:
                       ...
                       gs = kr1.getGroup(msg.to)
                       kr1.sendText(msg.to,"Banned all")
                       targets = []
                       for g in gs.members:
                           if _name in g.displayName:
                                targets.append(g.mid)
                       if targets == []:
                            kr1.sendText(msg.to,"Maaf")
                       else:
                           for target in targets:
                               if not target in Bots:
                                   try:
                                       ...
                                       f=codecs.open('st2__b.json','w','utf-8')
                                       json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                       kr1.sendText(msg.to,"Success Boss")
                                   except:
                                       kr1.sentText(msg.to,"Berhasil Di Banned")
#==============================================#
        if op.type == 26:
            msg = op.message
            if msg.contentType == 13:
